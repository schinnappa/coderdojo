...
public class Main {
    ...
    // Main method: Starting point of execution is this method
    public static void main(String[] args) {

        invokeArithmeticMethods();

        invokeRelationalMethods();

        invokeLogicalMethods();

        invokeBitwiseMethods();

        invokeAssignmentMethods();

        invokeUnaryMethods();
    }

    private static void invokeUnaryMethods() {
    }

    private static void invokeAssignmentMethods() {
    }

    private static void invokeBitwiseMethods() {
    ...
    private static void invokeLogicalMethods() {
        // Create an abject of type Bitwise
    ...
    private static void invokeRelationalMethods() {
    ...
    private static void invokeArithmeticMethods() {
